...
import { normalizeChronologyEntries } from './continuousHistory';

const toRow = (data: OfficialApplicationData) => ({
  user_id: data.userId, applicant_id: data.applicantId, role_id: data.roleId || null, position_applied: data.positionApplied,
